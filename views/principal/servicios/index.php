    ...
    <div class="container">
        <center>
            <div class="embed-responsive embed-responsive-16by9">
                <iframe class="embed-responsive-item" src="https://player.vimeo.com/video/849040068?h=43d863f1cd" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen></iframe>
            </div>
        </center>
    </div>
</section>
...
<section class="section blog-post-entry bg-light" id="next">
    <div class="container">
        ...
        <div class="row justify-content-center text-center mb-5">
            <div class="col-md-7">
                <h2 class="heading" data-aos="fade-up"><?php echo __('attractions_title'); ?>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 col-sm-6 col-12 post" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="media media-custom d-block mb-4 h-100">
                    ...
                    <div class="media-body">
                        ...
                        <h2 class="mt-0 mb-3"><a href="#"><?php echo __('attraction_boat_title'); ?></a></h2>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 col-12 post" data-aos="fade-up" data-aos-delay="200">
                <div class="media media-custom d-block mb-4 h-100">
                    ...
                    <div class="media-body">
                        <span class="meta-post"></span>
                        <h2 class="mt-0 mb-3"><a href="#"><?php echo __('attraction_banana_title'); ?></a></h2>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 col-12 post" data-aos="fade-up" data-aos-delay="300">
                <div class="media media-custom d-block mb-4 h-100">
                    ...
                    <div class="media-body">
                        <span class="meta-post"></span>
                        <h2 class="mt-0 mb-3"><a href="#"><?php echo __('attraction_turtles_title'); ?></a></h2>
