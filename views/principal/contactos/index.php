    ...
    <div class="container">
        <div class="row">
            <div class="col-md-7" data-aos="fade-up" data-aos-delay="100">
                ...
                <form action="#" method="post" class="bg-white p-md-5 p-4 mb-5 border">
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group">
                            <label for="phone"><?php echo __('contact_phone'); ?></label>
                    ...
                    <div class="row">
                        <div class="col-md-6 form-group">
                            <a href="https://wa.me/527661151203" class="btn btn-primary text-white"><?php echo __('hero_book_now'); ?></a>
                        </div>
                    </div>
                </form>
            ...
            <div class="col-md-5" data-aos="fade-up" data-aos-delay="200">
                <div class="row">
                    <div class="col-md-10 ml-auto contact-info">
                        <p><span class="d-block"><?php echo __('contact_address'); ?>:</span> <span> Calle Juan de la Barrera, <br> Colonia Emiliano Zapata CP: 93570</span></p>
            ...
            <div class="row justify-content-center text-center mb-5">
                <h2 class="heading" data-aos="fade-up"><?php echo __('contact_great_location'); ?></h2>
